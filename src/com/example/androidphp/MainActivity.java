...
public class MainActivity extends ActionBarActivity {
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://localhost/patito/getusers.php", params, new AsyncHttpResponseHandler() {
                @Override
    ...
    public void updateMySQLSyncSts(String json) {
        ...
        client.post("http://localhost/patito/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
